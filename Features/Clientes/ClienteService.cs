...
namespace Features.Clientes
{
    public class ClienteService : IClienteService
    {
        ...
        public void Adicionar(Cliente cliente)
        {
            ...
            _mediator.Publish(new ClienteEmailNotification("admin@me.com", 
                cliente.Email, "Olá", "Bem vindo!"));
        }
        ...
        public void Inativar(Cliente cliente)
        {
            ...
            cliente.Inativar();
            _mediator.Publish(new ClienteEmailNotification("admin@me.com", 
                cliente.Email, "Até breve", "Até mais tarde!"));
        }
        ...
        public void Remover(Cliente cliente)
        {
            ...
            _mediator.Publish(new ClienteEmailNotification("admin@me.com", 
                cliente.Email, "Adeus", "Tenha uma boa jornada!"));
