...
namespace NerdStore.Vendas.Domain.Models
{
    public class Voucher
    {
        ...
        public Voucher(string codigo, decimal? valorDesconto, decimal? percentualDesconto, int quantidade, TipoDescontoVoucher tipoVoucher, DateTime dataValidade, bool ativo, bool utilizado)
        {
            Codigo = codigo;
            ValorDesconto = valorDesconto;
            PercentualDesconto = percentualDesconto;
            Quantidade = quantidade;
            TipoDescontoVoucher = tipoVoucher;
    ...
    public class VoucherAplicavelValidation : AbstractValidator<Voucher>
    {
        ...
        public static string PercentualDescontoErroMsg => "O valor de porcentagem de desconto precisa ser superior a 0";
